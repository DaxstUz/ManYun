 ...
 *         2015年5月6日
 */
public class TcFragment extends Fragment implements OnClickListener {
   ...
   private  View view ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	    ...
	    try {
	       view = inflater.inflate(R.layout.fragment_tc, null);
	    } catch (InflateException e) {
	        
	    }
//        View view = inflater.inflate(R.layout.fragment_tc, null);
        

        if (NetReceiver.isConnected(TcFragment.this.getActivity()) != NetState.NET_NO) {
            initData();
        }
        GridView gridview = (GridView) view.findViewById(R.id.gv_cate_tc);

        adapter = new TypeShowAdapter(TcFragment.this.getActivity(), ats);
        //添加并且显示
        ...
        gridview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(TcFragment.this.getActivity(), ShowBooksActivity.class);
                intent.putExtra("cate", 1);
                intent.putExtra("author", ats.get(position));
                intent.putExtra("eventId", "sort_catigory");
                TcFragment.this.getActivity().startActivity(intent);
            }
        });
    ...
    private void initData() {
        // TODO Auto-generated method stub
//        Utils.startnet(TcFragment.this.getActivity());
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.POST,
                UrlConstant.UrlCategoryType, params,
...
//                Utils.showErrorMsg(TcFragment.this.getActivity());
            }
        }) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.ll_df_del:
                Toast.makeText(TcFragment.this.getActivity(), "你点击了删除", Toast.LENGTH_LONG).show();
                break;
