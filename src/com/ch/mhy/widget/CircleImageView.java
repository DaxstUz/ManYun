...
public class CircleImageView extends ImageView
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		if (mShowFlag && mFlagText != null)
		{
			...
			canvas.drawText(mFlagText, getWidth() / 2, (3 + FloatMath.cos((float) (Math.PI * 5 / 18))) * getHeight() / 4 + mFlagTextBounds.height() / 3, mFlagTextPaint);
		}
	}
	...
	private Bitmap getBitmapFromDrawable(Drawable drawable)
	{
		...
		try
		{
			...
			{
				bitmap = Bitmap.createBitmap(80, 80, BITMAP_CONFIG);//此处为设置位图的大小
			}
	...
	private void setup()
	{
		...
		mSweepGradient = new SweepGradient(getWidth() / 2, getHeight() / 2, new int[]
		{
				Color.rgb(255, 255, 255), Color.rgb(1, 209, 255)
		}, null);
